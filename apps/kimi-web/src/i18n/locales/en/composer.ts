export default {
  ...
  queueNext: 'Up next',
  queueSteerNow: 'Steer now',
  queueSteerTitle: 'Inject the queued message(s) into the running turn (Ctrl+S)',
  queueSteerOneTitle: 'Inject this message into the running turn',
